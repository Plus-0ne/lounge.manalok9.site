                    ...
                    <div class="row">
                        <div class="p-4 dashboard-section d-flex flex-wrap">
                            ...
                            <div class="col-12 col-sm-12 col-md-12 px-3">
                                <form action="{{ route('admin.Cat_Registration') }}" method="get">
                            ...
                            <div class="col-12 col-sm-12 col-md-12 p-3">
                                <div class="table-responsive row p-2">
                                    <table class="table table-striped w-100">
                                        ...
                                        <tbody>
                                            @if (!empty($data['registration_cat']) && $data['registration_cat']->count() > 0)
                                                @foreach ($data['registration_cat'] as $row)
                                ...
                                <div class="row">
                                    <div class="col-auto mt-3 mx-auto">
                                        {{ $data['registration_cat']->appends(request()->input())->links() }}
                                    </div>
                                </div>
                            </div>
                        </div>
