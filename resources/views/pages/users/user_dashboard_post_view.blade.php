                            ...
                            <div class="row">
                                <div class="col-auto">
                                    <a href="#" class="me-2" onclick="window.history.back()">
                                        <h5 class="text-light py-3 px-4" style="background-color: #1e2530; margin-top: -2.4rem;">
                                ...
                                <div class="text-center">
                                    ...
                                    <div class="user_post_reaction_control d-flex flex-row justify-content-evenly">
                                        <div class="u_reaction_control">
                                            <span class="hvr_reaction hvrr_{{ $data['postData']->first()->post_id }}">
                                                @if ($data['postReaction']->count() > 0)
                                                    @switch($data['postReaction']->first()->reaction)
                                                        @case('1')
                                                            <span class="react_to_post"
                                                                data-postid="{{ $data['postData']->first()->post_id }}"
                                                                data-postreaction="1">
                                                                @php
                                                                    echo strval('<svg width="28px" height="28px" viewBox="0 0 24 24"
                                                        ...
                                                        @case('2')
                                                            <span class="react_to_post"
                                                                ...
                                                                data-postreaction="2">
                                                                @php
                                                                    echo strval('<svg width="28px" height="28px" viewBox="0 0 1500 1500"
                                                                        ...
                                                                        <ellipse class="st1" cx="750.2" cy="751.1"
                                                                            rx="750" ry="748.8" />
                                                                        <g>
                                                        ...
                                                        @case('3')
                                                            <span class="react_to_post"
                                                                ...
                                                                data-postreaction="3">
                                                                @php
                                                                    echo strval('<?xml version="1.0" encoding="iso-8859-1"?>
                                                                    <!DOCTYPE svg
                                            ...
                                            <div class="u_reaction_container">
                                                <div class="ubackg_reaction">
                                                    <span class="react_to_post"
                                                        ...
                                                        data-postreaction="1">
                                                        @php
                                                            echo '<svg width="28px" height="28px" viewBox="0 0 24 24"
                                                            xmlns="http://www.w3.org/2000/svg">
                                                            <g>
                                                                <path fill="none" d="M0 0h24v24H0z" />
                                                                <path fill="#0072ff" color="#0072ff"
                                                    ...
                                                    <span class="react_to_post"
                                                        ...
                                                        data-postreaction="2">
                                                        @php
                                                            echo '<svg width="28px" height="28px" viewBox="0 0 1500 1500"
                                                            id="Layer_1" xmlns="http://www.w3.org/2000/svg">
                                                            <path class="st0"
                                                                d="M542.7 1092.6H377.6c-13 0-23.6-10.6-23.6-23.6V689.9c0-13 10.6-23.6 23.6-23.6h165.1c13 0 23.6 10.6 23.6 23.6V1069c0 13-10.6 23.6-23.6 23.6zM624 1003.5V731.9c0-66.3 18.9-132.9 54.1-189.2 21.5-34.4 69.7-89.5 96.7-118 6-6.4 27.8-25.2 27.8-35.5 0-13.2 1.5-34.5 2-74.2.3-25.2 20.8-45.9 46-45.7h1.1c44.1 1 58.3 41.7 58.3 41.7s37.7 74.4 2.5 165.4c-29.7 76.9-35.7 83.1-35.7 83.1s-9.6 13.9 20.8 13.3c0 0 185.6-.8 192-.8 13.7 0 57.4 12.5 54.9 68.2-1.8 41.2-27.4 55.6-40.5 60.3-2.6.9-2.9 4.5-.5 5.9 13.4 7.8 40.8 27.5 40.2 57.7-.8 36.6-15.5 50.1-46.1 58.5-2.8.8-3.3 4.5-.8 5.9 11.6 6.6 31.5 22.7 30.3 55.3-1.2 33.2-25.2 44.9-38.3 48.9-2.6.8-3.1 4.2-.8 5.8 8.3 5.7 20.6 18.6 20 45.1-.3 14-5 24.2-10.9 31.5-9.3 11.5-23.9 17.5-38.7 17.6l-411.8.8c-.2 0-22.6 0-22.6-30z" />
                                                            <path class="st0"
                                        ...
                                        <div>
                                            <span class="show_comment_section" data-post_id="{{ $data['postData']->first()->post_id }}">Comments ({{ $data['postData']->first()->PostComments->count() }})</span>
                                        </div>
                                        <div class="share_this_post" data-post_id="{{ $data['postData']->first()->post_id }}">
                                            <span>Share</span>
                                        </div>
