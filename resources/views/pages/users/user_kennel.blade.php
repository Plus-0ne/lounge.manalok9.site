        ...
        <div class="main">
            ...
            <div class="main-content h-100">
                <div class="container-fluid container-xl">
                    <div class="row">
                        <form action="{{ route('user.add_dog') }}" method="post">
                            @csrf
                            <div class="p-4 rounded-3 bg-light section_shadow border border-1 border-light">
                                <div class="row">
                                    ...
                                    <div class="col-6 col-sm-4">
                                        <input type="text" name="petno" class="form-control"
                                            placeholder="Dog IAGD #" required>
                                    </div>
                                    <div class="col-6 col-sm-5">
                                        <button type="submit" class="btn btn-primary"><i class="mdi mdi-plus"></i> Add
                                            Dog</button>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="py-4 px-0 rounded-3 bg-light section_shadow border border-1 border-light">
                            <div class="row">
                                <div class="col-12 text-start px-5 ms-sm-1 ms-md-3 ms-lg-5 row"
                                    style="margin-top: -3rem;">
                                    <div class="col-auto">
                                        <h5>
                                            <div class="dropdown">
                                                <button class="dropdown-toggle text-light py-3 px-4"
                                                    style="background-color: #1e2530;" type="button"
                                                    data-bs-toggle="dropdown">
                                                    <i class="mdi mdi-dog pe-1"></i> Dogs
                                                </button>
                                                <ul class="dropdown-menu">
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item" href="{{ route('other_animal') }}">
                                                            <h5><i class="mdi mdi-help-circle-outline pe-1"></i> Other
                                                                Animals</h5>
                                                        </a>
                                                    </li>
                                                </ul>
                                    ...
                                    <div class="col-auto mx-auto mx-sm-0">
                                        <a href="kennel_unregistered"
                                            class="btn btn-success rounded-pill p-3 py-2 py-sm-3 mb-1 fw-bold">
                                            <i class="mdi mdi-dog"></i> PRE-REGISTERED DOGS
                                            ({{ $data['kennel_count'] }})
                                        </a>
                                    </div>
                                    <div class="col-auto mx-auto mx-sm-0">
                                        <button type="button"
                                            class="btn btn-primary btn-size-95-rem shadow p-3 py-2 py-sm-3 mb-1"
                                                ...
                                                @foreach ($data['member_dogs'] as $row)
                                                    <tr>
                                                        <td class="text-end align-middle ps-5">
                                                            <img class="shadow"
                                                                src="{{ asset($row->AdtlInfo->FilePhoto->file_path ?? 'img/no_img.jpg') }}"
                                                                style="height: 10rem;">
                                                        </td>
                                                        ...
                                                        <td class="text-center align-middle pe-5">
                                                            ...
                                                            @else
                                                                <div class="mb-3">
                                                                    <a href="{{ empty($row->PetNo) ? '#' : 'kennel_info/' . $row->PetNo }}"
                                                                        class="btn btn-primary {{ empty($row->PetNo) ? 'disabled' : '' }}">
                                            ...
                                            @else
                                                <tr>
                                                    <td class="text-center align-middle" colspan="8">
                                                        <label
                                                            class="rounded-pill bg-info text-light px-5 py-3 my-2 fw-bold">
                                                            DOGS LIST IS EMPTY!
                                                        </label>
                                                    </td>
                                                </tr>
    ...
    $(document).ready(function() {
        @if (Session::has('response'))
            @switch(Session::get('response'))
                ...
                @case('dog_approval_pending')
                toastr["warning"]("Dog approval pending", "Warning");
                @break

                @case('dog_claimed')
                toastr["warning"]("Dog has already been claimed", "Warning");
                @break

                @case('dog_not_found')
                toastr["warning"]("Dog not found", "Warning");
                @break

                @case('pet_added')
                toastr["success"]("Dog registration added", "Success");
                @break
