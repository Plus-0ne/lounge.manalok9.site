...
<body>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-sm-12 col-xxl-4">
                                        <div class="mb-3">
                                            ...
                                            <input id="microchip" type="text" class="form-control form-control-sm"
                                                aria-describedby="helpId">
                                            <small id="helpId" class="form-text text-muted">
                                                Enter cat's microchip number ( <i class="text-danger">If available</i> )
                                            </small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-sm-12 col-xxl-4">
                                        <div class="mb-3">
                                            ...
                                            <input id="breed" type="text" class="form-control form-control-sm" list="cat_breeds"
                                                aria-describedby="helpId">
                                            <small id="helpId" class="form-text text-muted">
                                                Enter cat's Breed
                                            </small>
                                    ...
                                    <div class="col-12 col-sm-12 col-xxl-4">
                                        <div class="mb-3">
                                            ...
                                            <input id="height" type="text" class="form-control form-control-sm"
                                                aria-describedby="helpId">
                                            <small id="helpId" class="form-text text-muted">
                                                Enter cat's height in centimeters
                                            </small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-sm-12 col-xxl-4">
                                        <div class="mb-3">
                                            ...
                                            <input id="weight" type="text" class="form-control form-control-sm"
                                                aria-describedby="helpId">
                                            <small id="helpId" class="form-text text-muted">
                                                Enter cat's weight in centimeters
                                            </small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-sm-12 col-xxl-4">
                                        <div class="mb-3">
                                            <div class="d-flex justify-content-between justify-content-xl-start">
                                                ...
                                                <div class="InputhelpIcon ms-2" data-bs-toggle="popover"
                                                data-bs-trigger="manual" data-bs-placement="top"
                                                data-bs-content="Co-ownership of a cat refers to a situation where two or more individuals share ownership and responsibility for a single cat. This could be for various reasons, such as family members sharing the care of a pet, friends who decide to jointly adopt a cat, or breeders who collaborate on raising and showing cats.">
                                                    <span class="mdi mdi-help-circle"></span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-12 col-sm-12 col-xxl-4">
                                        <div class="mb-3">
                                            <div class="d-flex justify-content-between justify-content-xl-start">
                                                ...
                                                <div class="InputhelpIcon ms-2" data-bs-toggle="popover"
                                                data-bs-trigger="manual" data-bs-placement="top"
                                                data-bs-content="A &quot;cat supporting document&quot; refers to any document or paperwork that provides additional information or evidence related to a cat. These documents are often required or helpful in various situations to demonstrate ownership, health status, or compliance with certain regulations.">
                                                    <span class="mdi mdi-help-circle"></span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-12 col-sm-12 col-xxl-4">
                                        <div class="mb-3">
                                            ...
                                            <input id="sire_breed" type="text" class="form-control form-control-sm"
                                                list="cat_breeds" aria-describedby="helpId">
                                            <small id="helpId" class="form-text text-muted">
                                                Enter sire's breed
                                            </small>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="d-flex flex-column justify-content-start align-items-end">
                                        <div class="d-flex flex-row w-100 justify-content-between">
                                            ...
                                            <div>
                                                <button id="registerCatButton" type="button" class="btn btn-primary btn-sm">
    ...
    <script src="{{ asset('js/animal-pages/cat-registration.js') }}"></script>
