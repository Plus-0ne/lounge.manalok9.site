...
<body>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-sm-12 col-xxl-4">
                                        <div class="mb-3">
                                            <div class="d-flex justify-content-between justify-content-xl-start">
                                                ...
                                                data-bs-content="A dog microchip number is a unique identifier assigned to an individual dog through a microchip implant. Microchips are small, electronic devices about the size of a grain of rice that are injected under the skin, usually between the shoulder blades. Each microchip contains a specific alphanumeric code that serves as the dog's unique identification number.">
                                            ...
                                            <input id="microchip" type="text" class="form-control form-control-sm"
                                                aria-describedby="helpId">
                                            <small id="helpId" class="form-text text-muted">
                                                Enter dog's microchip number ( <i class="text-danger">If available</i> )
                                            </small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-sm-12 col-xxl-4">
                                        <div class="mb-3">
                                            ...
                                            <input id="breed" type="text" class="form-control form-control-sm" list="dog_breeds"
                                                aria-describedby="helpId">
                                            <small id="helpId" class="form-text text-muted">
                                                Enter dog's Breed
                                            </small>
                                    ...
                                    <div class="col-12 col-sm-12 col-xxl-4">
                                        <div class="mb-3">
                                            <label for="dog_color" class="form-label">
                                                <span class="mdi mdi-palette"></span> Pet Color
                                            </label>
                                            <input id="dog_color" type="text" class="form-control form-control-sm"
                                                aria-describedby="helpId">
                                            <small id="helpId" class="form-text text-muted">
                                                Enter dog's color
                                            </small>
                                    ...
                                    <div class="col-12 col-sm-12 col-xxl-4">
                                        <div class="mb-3">
                                            <label for="dog_marking" class="form-label">
                                                <span class="mdi mdi-star"></span> Markings
                                            </label>
                                            <input id="dog_marking" type="text" class="form-control form-control-sm"
                                                aria-describedby="helpId">
                                            <small id="helpId" class="form-text text-muted">
                                                Enter dog's markings
                                            </small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-sm-12 col-xxl-4">
                                        <div class="mb-3">
                                            ...
                                            <input id="height" type="text" class="form-control form-control-sm"
                                                aria-describedby="helpId">
                                            <small id="helpId" class="form-text text-muted">
                                                Enter dog's height in centimeters
                                            </small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-sm-12 col-xxl-4">
                                        <div class="mb-3">
                                            ...
                                            <input id="weight" type="text" class="form-control form-control-sm"
                                                aria-describedby="helpId">
                                            <small id="helpId" class="form-text text-muted">
                                                Enter dog's weight in kilograms
                                            </small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-sm-12 col-xxl-4">
                                        <div class="mb-3">
                                            <div class="d-flex justify-content-between justify-content-xl-start">
                                                ...
                                                <div class="InputhelpIcon ms-2" data-bs-toggle="popover"
                                                data-bs-trigger="manual" data-bs-placement="top"
                                                data-bs-content="Dog co-owners are individuals or parties who jointly own a dog. Co-ownership occurs when two or more people share ownership responsibilities, rights, and decision-making related to the dog. Each co-owner has a legal and ethical obligation to care for the dog's well-being.">
                                                    <span class="mdi mdi-help-circle"></span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-12 col-sm-12 col-xxl-4">
                                        <div class="mb-3">
                                            <div class="d-flex justify-content-between justify-content-xl-start">
                                                ...
                                                <div class="InputhelpIcon ms-2" data-bs-toggle="popover"
                                                data-bs-trigger="manual" data-bs-placement="top"
                                                data-bs-content="A &quot;dog supporting document&quot; refers to any document or paperwork that provides additional information or evidence related to a dog. These documents are often required or helpful in various situations to demonstrate ownership, health status, or compliance with certain regulations.">
                                                    <span class="mdi mdi-help-circle"></span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-12 col-sm-12 col-xxl-4">
                                        <div class="mb-3">
                                            ...
                                            <input id="cveter_record" type="file" class="form-control form-control-sm"
                                                aria-describedby="fileHelpId">
                                            <small id="fileHelpId" class="form-text">
                                                Upload dog's record (only when applicable) : acceptable format (jpeg,
                                                jpg, png, webp, gif)
                                            </small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-sm-12 col-xxl-4">
                                        <div class="mb-3">
                                            ...
                                            <input id="kennel_link" type="text" class="form-control form-control-sm"
                                                aria-describedby="helpId">
                                            <small id="helpId" class="form-text text-muted">
                                                Enter kennel Online Profile (URL/link)
                                            </small>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-12 col-sm-12 col-xxl-4">
                                        <div class="mb-3">
                                            ...
                                            <input id="sire_breed" type="text" class="form-control form-control-sm"
                                                list="dog_breeds" aria-describedby="helpId">
                                            <small id="helpId" class="form-text text-muted">
                                                Enter sire's breed
                                            </small>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="d-flex flex-column justify-content-start align-items-end">
                                        <div class="d-flex flex-row w-100 justify-content-between">
                                            ...
                                            <div>
                                                <button id="registerDogButton" type="button" class="btn btn-primary btn-sm">
    ...
    {{-- Modals --}}
    @include('pages.users.animal-pages.datalist-dog-breeds')
    ...
    <script src="{{ asset('js/animal-pages/dog-registration.js') }}"></script>
