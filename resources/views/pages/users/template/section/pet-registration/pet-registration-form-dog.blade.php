...
<div class="col-12 col-md-6 p-2">
    <div class="input-container">
        <input id="pet_breed" class="input-control" type="text" name="pet_breed" placeholder="*Breed" list="dog_breeds">
    </div>
</div>
<div class="col-12 col-md-6 p-2">
    <div class="input-container">
        <select id="pet_eyecolor" class="input-control" name="pet_eyecolor">
...
<div class="col-12 col-md-6 p-2">
    <div class="input-container">
        <button class="image_btn btn btn-secondary w-100" type="button">Upload a photo of your dog</button>
...
<div class="col-12 col-md-6 p-2">
    <div class="input-container">
        <button class="file_btn btn btn-secondary w-100" type="button">Upload Your Dog's Veterinary Record (only when applicable)</button>
...
<div class="col-12 col-md-6 p-2">
    <div class="input-container">
        <input id="pet_shelter" class="input-control" type="text" name="pet_shelter" placeholder="Kennel Information">
    </div>
</div>
<div class="col-12 col-md-6 p-2">
    <div class="input-container">
        <input id="pet_shelter_url" class="input-control" type="text" name="pet_shelter_url" placeholder="Kennels Online Profile (URL/link)" title="FB URL or other social media account">
    </div>
</div>
<div class="col-12 col-md-6 p-2">
    <div class="input-container">
...
<div class="col-12 col-md-6 p-2">
    <div class="input-container">
        <input id="pet_sire_breed" class="input-control" type="text" name="pet_sire_breed" placeholder="Breed" list="dog_breeds">
    </div>
</div>
<div class="col-12 col-md-6 p-2">
    <div class="input-container">
...
<div class="col-12 col-md-6 p-2">
    <div class="input-container">
        <input id="pet_dam_breed" class="input-control" type="text" name="pet_dam_breed" placeholder="Breed" list="dog_breeds">
    </div>
</div>
<div class="col-12 col-md-6 p-2">
    <div class="input-container">
