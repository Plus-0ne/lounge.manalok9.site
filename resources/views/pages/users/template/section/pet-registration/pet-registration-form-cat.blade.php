...
<div class="col-12 col-md-6 p-2">
    <div class="input-container">
        <button class="image_btn btn btn-secondary w-100" type="button">Upload a photo of your cat</button>
...
<div class="col-12 col-md-6 p-2">
    <div class="input-container">
        <button class="file_btn btn btn-secondary w-100" type="button">Upload Your Cat's Veterinary Record (only when applicable)</button>
...
<div class="col-12 col-md-6 p-2">
    <div class="input-container">
        <input id="pet_shelter" class="input-control" type="text" name="pet_shelter" placeholder="Cattery Information">
    </div>
</div>
<div class="col-12 col-md-6 p-2">
    <div class="input-container">
        <input id="pet_shelter_url" class="input-control" type="text" name="pet_shelter_url" placeholder="Cattery's Online Profile (URL/link)" title="FB URL or other social media account">
    </div>
</div>
<div class="col-12 col-md-6 p-2">
    <div class="input-container">
