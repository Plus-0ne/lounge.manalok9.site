...
<form id="pet_update_form" action="{{ route('user.update_dog_unregistered') }}" method="post" enctype="multipart/form-data">
    @csrf
    <div class="modal fade" id="update_dog_unregistered" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header py-4 px-3">
                    <h5 class="modal-title" id="exampleModalLabel">
                        Verify Dog Registration
                    </h5>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-6 py-1">
                                ...
                                <select class="form-control" name="pet_eyecolor">
                                    ...
                                    @foreach ([ 'Black', 'Brown', 'Blue', 'Red', 'Hazel', 'Gray', 'Green', 'Others' ] as $eye_color)
                                        <option value="{{ $eye_color }}" {{ $data['pet_data']->EyeColor == $eye_color ? 'selected' : '' }}> {{ $eye_color }} </option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-12 col-lg-6 py-1">
