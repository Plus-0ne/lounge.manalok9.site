...
<form id="pet_update_form" action="{{ route('user.update_cat_unregistered') }}" method="post" enctype="multipart/form-data">
    @csrf
    <div class="modal fade" id="update_cat_unregistered" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header py-4 px-3">
                    <h5 class="modal-title" id="exampleModalLabel">
                        Verify Cat Registration
                    </h5>
                ...
                <div class="modal-body py-4 px-3">
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-6 py-1">
                                <label class="form-label">
                                    <i class="mdi mdi-file-image mdi-24px pe-1"></i> Upload a photo of your cat:
                                </label>
                            ...
                            <div class="col-12 col-lg-6 p-2">
                                <label class="form-label">
                                    <i class="mdi mdi-file-upload mdi-24px pe-1"></i> Upload your cat's veterinary record (only when applicable):
                                </label>
