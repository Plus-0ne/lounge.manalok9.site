                                ...
                                <div class="col-12 text-start px-5 ms-sm-1 ms-md-3 ms-lg-5 row" style="margin-top: -3rem;">
                                    <div class="col-auto">
                                        <h5 class="text-light py-3 px-4" style="background-color: #475c7c;">
                                            <i class="mdi mdi-cat pe-2"></i> IAGD CAT REGISTRATION
                                        </h5>
                                    </div>
                                    <div class="col-auto mx-auto ms-sm-0">
                                        <a href="cattery" class="btn btn-success rounded-pill p-3 py-2 py-sm-3 mb-1 fw-bold">
                                            <i class="mdi mdi-cat"></i> Registered Cats ({{ $data['cattery_count'] }})
                                        </a>
                                    </div>
                                </div>
                            </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center align-middle pe-5">
                                                            ...
                                                            @if($row->Status == 1 || $row->Status == 4)
                                                                ...
                                                                @endif
                                                            @endif
                                                            <a href="cattery_unregistered_info/{{ $row->PetUUID }}" class="btn btn-primary mt-1 btn-sm">
                                                                <i class="mdi mdi-eye"></i>  Verify pet
                                                            </a><br>
                                                            <a href="cancel_cat_registration/{{ $row->PetUUID }}" class="cancel-registration btn btn-danger mt-1 btn-sm">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('.upload-receipt').on('click', function() {
            UploadReceipt($(this), 'unregistered_cat', '{{ asset("/") }}');
        });
    });
</script>
