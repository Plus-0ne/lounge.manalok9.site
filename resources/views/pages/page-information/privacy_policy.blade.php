...
<head>
    ...
    <link href="{{ asset('page-information-asset/css/styles.css') }}" rel="stylesheet" />
    <script src="https://code.iconify.design/2/2.2.1/iconify.min.js"></script>
</head>

<body id="page-top" style="position: static !important; min-height: 0 !important; top: 0 !important;">
    <style type="text/css">
    ...
    <!-- Navigation-->
    <nav class="navbar navbar-expand-lg text-uppercase fixed-top" id="mainNav" style="background-color: #1E2530;">
        <div class="container">
            <a class="navbar-brand" href="#page-top">
                <img src="{{ asset('page-information-asset/assets/img/Logo.png') }}" class="img-fluid" alt="..." style="max-height: 50px;">
            </a>
            <button class="navbar-toggler text-uppercase font-weight-bold text-white rounded" type="button"
                data-bs-toggle="collapse" data-bs-target="#navbarResponsive" aria-controls="navbarResponsive"
                aria-expanded="false" aria-label="Toggle navigation" style="background-color: #6423CE;">
                Menu
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded"
                            href="https://www.metaanimals.tech">Metaanimals</a></li>
                    <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded"
                            href="https://www.manalok9.com">ManaloK9</a></li>
                    <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded"
                            href="https://www.iagd-centralized.metaanimals.org">Animal Registry</a></li>
                </ul>
            </div>
        </div>
    </nav>
    <section class="page-section mb-0" id="about" style="padding-bottom: 0;">
        <div class="container">
            <!-- about Section Heading-->
            <!-- <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0 text-white">SUPER DOG NUTRITION</h2> -->
            <!-- Icon Divider-->
            <div class="divider-custom">
            </div>
            <div class="row justify-content-center row-feeding" style="flex-direction: row-reverse;">
                <div class="col-8">
                    <h2 align="center">PRIVACY POLICY</h2>
                    <p>Effective date: 2022-09-01</p>

                    <p>1. Introduction
                    <p>Welcome to Meta Animals Technologies Corporation.</p>
                    <p>Meta Animals Technologies Corporation (“us”, “we”, or “our”) operates
                        http://metaanimals.org/consult/vet (hereinafter referred to as “Service”).
                        Our Privacy Policy governs your visit to http://metaanimals.org/consult/vet, and explains how we
                        ...
                        Conditions. Our Terms and Conditions (“Terms”) govern all use of our Service and together with
                        the Privacy Policy constitutes your agreement with us (“agreement”).</p>

                    <p>2. Definitions</p>
                    <p>SERVICE means the http://metaanimals.org/consult/vet website operated by Meta Animals
                        Technologies Corporation. PERSONAL DATA means data about a living individual who can be
                        identified from those data (or from those and other information either in our possession or
                    ...
                    <p>DATA CONTROLLER means a natural or legal person who (either alone or jointly or in common with
                        ...
                        your data.</p>
                    <p>DATA PROCESSORS (OR SERVICE PROVIDERS) means any natural or legal person who processes the data
                    ...
                    <p>THE USER is the individual using our Service. The User corresponds to the Data Subject, who is
                    ...
                    <p>We may also collect information that your browser sends whenever you visit our Service or when
                        you access Service by or through any device (“Usage Data”).
                        ...
                        diagnostic data.
                        When you access Service with a device, this Usage Data may include information such as the type
                        of device you use, your device unique ID, the IP address of your device, your device operating
                        system, the type of Internet browser you use, unique device identifiers and other diagnostic
                        data.</p>
                    <p>Location Data</p>
                    ...
                    <p>0.2. Preference Cookies: We use Preference Cookies to remember your preferences and various
                        settings.</p>
                    <p>0.3. Security Cookies: We use Security Cookies for security purposes.</p>
                    <p>0.4. Advertising Cookies: Advertising Cookies are used to serve you with advertisements that may
                    ...
                    <p>5. Use of Data</p>
                    <p>Meta Animals Technologies Corporation uses the collected data for various purposes:</p>
                    ...
                    <p>We will retain and use your Personal Data to the extent necessary to comply with our legal
                    ...
                    <p>If you are located outside Philippines and choose to provide information to us, please note that
                        we transfer the data, including Personal Data, to Philippines and process it there.</p>
                    ...
                    <p>Meta Animals Technologies Corporation will take all the steps reasonably necessary to ensure that
                    ...
                    <p>We aim to take reasonable steps to allow you to correct, amend, delete, or limit the use of your
                        Personal Data. If you wish to be informed what Personal Data we hold about you and if you want
                        it to be removed from our systems, please email us at customersupport@metaanimals.org.</p>
                    ...
                    <p>0.4. the right of restriction. You have the right to request that we restrict the processing of
                        your personal information;</p>
                    <p>0.5. the right to data portability. You have the right to be provided with a copy of your
                    ...
                    <p>For more information, please contact your local data protection authority in the European
                        Economic Area (EEA).</p>
                    ...
                    <p>CalOPPA is the first state law in the nation to require commercial websites and online services
                        ...
                        whom it is being shared, and to comply with this policy.</p>
                    <p>According to CalOPPA we agree to the following:</p>
                    <p>0.1. users can visit our site anonymously;</p>
                    <p>0.2. our Privacy Policy link includes the word “Privacy”, and can easily be found on the home
                    ...
                    <p>0.4. users are able to change their personal information by emailing us at
                        customersupport@metaanimals.org.</p>
                    ...
                    <p>If you are a California resident, you are entitled to learn what data we collect about you, ask
                        to delete your data and not to sell (share) it. To exercise your data protection rights, you can
                        make certain requests and ask us:</p>
                    <p>0.1. What personal information we have about you. If you make this request, we will return to
                        you:</p>
                    ...
                    <p>0.0.6. A list of categories of personal information that we have sold, along with the category of
                        any other company we sold it to. If we have not sold your personal information, we will inform
                        you of that fact.</p>
                    <p>0.0.7. A list of categories of personal information that we have disclosed for a business
                    ...
                    <p>Please note, you are entitled to ask us to provide you with this information up to two times in a
                        ...
                        to the personal information we collected about you in the previous 12 months.</p>
                    <p>0.2. To delete your personal information. If you make this request, we will delete the personal
                        ...
                        not be able to use certain functions that require your personal information to operate.</p>
                    <p>0.3. To stop selling your personal information. We don’t sell or rent your personal information
                        ...
                        disclosure or deletion at any time.</p>
                    <p>If you submit a request to stop selling your personal information, we will stop making such
                        transfers. Please note, if you ask us to delete or stop selling your data, it may impact your
                        ...
                        circumstances, we will discriminate against you for exercising your rights. To exercise your
                        California data protection rights described above, please send your request(s) by email:
                        customersupport@metaanimals.org.</p>
                    ...
                    <p>Our Service may contain links to other sites that are not operated by us. If you click a third
                        ...
                        For example, the outlined privacy policy has been made using PolicyMaker.io, a free tool that
                        helps create high-quality legal documents. PolicyMaker’s privacy policy generator is an
                        easy-to-use tool for creating a privacy policy for blog, website, e-commerce store or mobile
                        app.</p>
    ...
    <div class="copyright py-4 text-center text-white">
        <div class="container"><small class="copyright-text">Copyright &copy; 2022 Meta Animals. All Rights
                Reserved</small></div>
    </div>
    ...
    <!-- Core theme JS-->
    <script src="{{ asset('page-information-asset/js/scripts.js') }}"></script>
    <!-- * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *-->
    <!-- * *                               SB Forms JS                               * *-->
    ...
    <script type="text/javascript">
        function googleTranslateElementInit() {
            ...
            var language_select = document.getElementsByClassName('goog-te-combo');
            var event = new Event('change');

            $('#translate_en').on('click', function() {
                if ($('.goog-te-combo').val() != 'en' && $('.goog-te-combo option[value="en"]').length > 0) {
                    language_select[0].dispatchEvent(event);
            ...
            $('#translate_id').on('click', function() {
                if ($('.goog-te-combo').val() != 'id' && $('.goog-te-combo option[value="id"]').length > 0) {
                    language_select[0].dispatchEvent(event);
        ...
        function translate_img(lang_id) {
            $('img').each(function() {
                let file_name = $(this).attr('data-src');
                let file_ext = '.' + file_name.split('.').pop();

                let new_file_name = file_name.replace(file_ext, '-' + lang_id + file_ext);

                // if (image_exists(new_file_name)) {
                $(this).attr('src', new_file_name);
                // } else {
