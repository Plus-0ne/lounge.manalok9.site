$(document).ready(function () {
    ...
    /* -------------------------------------------------------------------------- */
    $(document).on('click', '#registerDogButton', function () {
        /* New form data */
        ...
        fd.append('dog_color', dog_color.val());
        fd.append('dogs_marking', dogs_marking.val());
        ...
        $.ajax({
            method: "POST",
            url: window.currentBaseUrl + "/user/pet/dog/register",
            data: fd,
            cache: false,
            processData: false,
            contentType: false,
